...
- `docs/開発プロセス/テスト観点表テンプレート.md` — 影響度トリガー該当時のテスト仕様確定様式（記載方式は Phase 7 の実施要否で分岐）
